...
- Questions Generator for free template-powered question sets by grade, topic, skill, and count
...
The current generated questions are created offline in the browser with templates and variation logic. To use hosted AI-generated questions later, add a server endpoint that calls your AI provider and keeps API keys off the client.
